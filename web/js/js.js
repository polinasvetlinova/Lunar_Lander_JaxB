    ...
    $.ajax({
        ...
        success: function (dataXml) {
            $(dataXml).find('config').each(function (i)
            {
                ...
                var nav = $(this).find('nave').text(); //$(this).attr('edad');
                var lun = $(this).find('luna').text(); //$(this).attr('edad');
...
function cargarSeleccion() {
    ...
    construirPartida(confXML[i].nave, confXML[i].difi, confXML[i].luna);
...
function guardarConfi() {
    ...
    $.ajax({
        ...
        success: function (u) {
            confXML[newId] = {nave: modeloNave, difi: dificultad, luna: modeloLuna};
            $("#nomConf").val("");
            $("#configuracion").append(
